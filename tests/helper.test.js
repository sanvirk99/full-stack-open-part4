...
describe('favourite blog',() => {
    ...
    test("find blog with most likes", () => {
        ...
        assert.deepStrictEqual(result,{ //use deep since strict works for primitative and does not check the properties of objects to be same
            title: "Canonical string reduction",
            author: "Edsger W. Dijkstra",
            likes: 12
          })
